...
public class HugeConfig2Test extends BaseUnitTest {
    ...
    public void testHugeConfig() throws Exception {
        ...
        Assert.assertThrows(ConfigException.class, () -> {
            new HugeConfig2((Configuration) null);
        });
    }
    ...
    public void testHugeConfigWithConfiguration() throws Exception {
        ...
        pc.read(new FileReader(new File(CONF)));
        HugeConfig2 config = new HugeConfig2(pc);
    ...
    public void testHugeConfigWithTypeError() {
        ...
        Assert.assertThrows(ConfigException.class, () -> {
            new HugeConfig2(PATH + "test-type-error.conf");
        });
    }
    ...
    public void testHugeConfigWithCheckError() throws Exception {
        ...
        Assert.assertThrows(ConfigException.class, () -> {
            new HugeConfig2(PATH + "test-check-error.conf");
        });
    }
    ...
    public void testHugeConfigWithListOptionError() throws Exception {
        ...
        Assert.assertThrows(IllegalStateException.class, () -> {
            new HugeConfig2(PATH + "test-list-error.conf");
        });
    }

//    @Test
    public void testSaveHugeConfig() throws IOException,
         ...
         *
         * ================================================
         * write() will produce unexpected format content:
         * ================================================
         * group1.text1=file-text1-value
         * group1.text2=file-text2-value
         * group1.text3=CHOICE-3
         ...
         * group1.bool=false
         *
         * group1.class=class java.lang.String
         *
         * group1.list=file-v1
         * group1.list=file-v2
         * group1.list=file-v3
         * group1.map=key1:value1
         * group1.map=key3:value3
         *
         * group1.weekday=SUNDAY
         * group1.weekdays=SATURDAY
         * group1.weekdays=FRIDAY
         *
         * group1.no-used=value
         *
         */
        config.write(new FileWriter(copiedFile));
        Assert.assertTrue(copiedFile.exists());
        Assert.assertTrue(copiedFile.length() > 0);

        try {
            HugeConfig2 copiedConfig = new HugeConfig2(copiedFile.getPath());
    ...
    public void testFromMapConfigurationWithList() {
        ...
        HugeConfig2 hugeConfig = new HugeConfig2(mapConfiguration);
